...
Durch die \Code{RandomAI} ist uns das grundlegende Problem aufgefallen, dass sich die \acs{KI} selber tötet.
...
zu implementieren.
Die \acs{KI} soll aus allen Aktionen eine zufällige Aktion auswählt, die sie nicht direkt verlieren lässt.
...
folgenden Zug tötete, jedoch häufig in Sackgassen läuft. \todo{Bild einfügen}
