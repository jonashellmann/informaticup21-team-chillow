...
Zunächst war eine Überlegung, eine \ac{KI} mithilfe von generierten Daten trainiert werden kann, je nach vorliegender
Spielsituation eigene Entscheidungen treffen zu können, \bspw unter Einsatz von neuronalen Netzen.
...
Ist es nicht möglich, ein ausreichend umfangreiche Menge an Daten generieren zu können, besteht die Gefahr, dass eine
