...
Die \Code{SearchTreePathfindingAI} kombiniert die Stärken der \Code{SearchTreeAI} und der \Code{PathfindingAI}.
...
Die Priorisierung hinsichtlich der \Code{PathfindingAI} ist so umgesetzt, dass der \Code{PathfindingSearchTreeAI} bei
der Initialisierung ein Parameter übergeben wird, der eine Toleranz (zwischen 0 und 1) darstellt.
Eine mögliche Aktion der \Code{SearchTreeAI} muss mindestens, die maximale Anzahl Pfade multipliziert mit der
