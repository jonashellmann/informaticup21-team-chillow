...
Aktions-Kombinationen eine bestimmte Anzahl an Zügen in Zukunft zu simulieren und einen Teilbaum zu finden, bei dem
...
Die Buchstaben an den Pfaden sollen jeweils die simlulierte Aktion kennzeichnen.
...
Gibt es einen Pfad bis zur vorletzten Ebene, nach der bei der Kombination aller gegnerischen Aktionen immer ein
Überleben auf der untersten Ebene folgen, ist eine Ausgangsaktion gefunden, die in dem aktuellen Zu ausgeführt werden
...
Anzahl reduziert, indem in die Simulation nicht mehr immer alle Spieler einberechnet werden, sondern nur noch solche,
...
$470.184.984.576$ auf lediglich $(3 ^ 5) ^ 3 = 32.768$ Kombinationen.
