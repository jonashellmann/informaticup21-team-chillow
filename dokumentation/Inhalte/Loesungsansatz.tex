...
Durch eine \acs{KI}, die zufällige Aktionen ausführt, ist uns das grundlegende Problem aufgefallen, dass
...
Durch die Implementierung der \Code{NotKillingItselfAI} fiel auf, dass die \acs{KI} sich zwar nicht mehr im
...
Aktion noch ein möglicher Pfad existiert. \todo{In einem Bild verdeutlichen warum das ein Bewertungskriterium darstellt}
...
Ziel ist es, dass die die \Code{NotKillingItselfAI}, falls möglich, auch nur Aktionen berechnet,
