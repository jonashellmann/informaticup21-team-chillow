...
Der in der Aufgabenstellung geforderte Umfang des Lösungsvorschlags \Vgl{informaticup21-aufgabe} wurde in diesem Projekt
...
einer Desktop-Anwendung, auf deren Entwicklung in \Kapitel{subsec:oberflaeche-konsole} und
\Kapitel{subsec:oberflaeche-pygame} eingegangen wird.
Diese Oberflächen erlauben neben der automatischen Berechnung der nächsten Aktion durch eine \ac{KI} durch in
\Kapitel{ch:benutzerhandbuch} genannte Konfigurationen auch die Interaktion mit einem menschlichen Spieler mittels
Benutzereingaben. \\
...
Bei der Entwicklung des Produktiv-Codes wurden \ua Standards festgelegt und eingehalten, der Code dokumentiert und die
Wartbarkeit des Projektes berücksicht (siehe \Kapitel{ch:software-qualitaet} und \Kapitel{sec:erweiterbarkeit})
Viel Zeit ist darüber hinaus in die Implementierung von automatisierten Tests geflossen, die in \Kapitel{sec:tests}
...
In \Kapitel{Einsatz von PRs im Git-Workflow} wird die kollaborative Zusammenarbeit an diesem Projekt mit der
Unterstützung von Git und Github erklärt.
\Kapitel{sec:github-actions} geht dann insbesondere auf Continious Integration durch die Nutzung von Github Actions
als Build-Server. \\

\todo{Ggf. um Erweiterungen ergänzen}
