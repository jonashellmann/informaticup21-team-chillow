...
Der grobe Ablauf dieser Methode ist wie folgt und kann genauer im Diagramm nachvollzogen werden.
\todo{Diagramm einfügen}
...
Sollte also ein neuer Spielzug durch die Aktion entstanden sein, werden die Spieler in die \Code{Cell}s eingetragen,
