...
seiner Geschwindigkeit und seiner Ausrichtung aktualisiert und er wird im \Code{Game} in die \Code{Cell}s eingetragen,
...
Mithilfe dieser Logik des \Code{GameService} können wir Spiele ohne Nutzung des spe\ed-Servers durchführen.
