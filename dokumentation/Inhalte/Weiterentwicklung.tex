...
Für eine bessere Übersichtlichkeit wurde das Tool PDoc eingesetzt, welches aus diesen Kommentare im Code automatisiert
HTML-Seiten generieren kann. \Vgl{PDoc}
Diese Dateien wurden dann in ein eigenes Repo auf Github gepusht, für welches Github Pages \Vgl{github-pages}
aktiviert wurden.
Hiermit ist es möglich, die Enteickler-Dokumentation unter folgender URL bereitzustellen:
