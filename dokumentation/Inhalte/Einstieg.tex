...
Zudem funktioniert die Auflösung komplexerer Abhängigkeiten von Paketen von diesem Tool sehr gut. \Vgl{poetry}
...
Um die zu entwickelnde \ac{KI} ohne die Server-Verbimdung manuell testen zu können, haben wir bei der Implementierung
...
einer Online-Version im Browser das Spiel testen zu können, begonnen, die Spiellogik zu analysieren.
...
sehr gut wiederverwendet werden konnte, in einer Klasse \Code{GameService} implementiert.
...
% TODO: Hier schon auf die GameService-Logik eingehen oder erst im Kapitel Implementierung?