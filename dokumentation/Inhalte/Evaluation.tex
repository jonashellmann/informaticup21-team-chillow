...
Es wird deutlich, dass die Kombination aus der \Code{PathfindingAI} und der \Code{SearchTreeAI} im Vergleich zu unseren
anderen Lösungsansätzen die besten Ergebnisse in den Spielen erzielt, sodass diese schlussendlich auch für die Abgabe
des Projektes ausgewählt wurde.
