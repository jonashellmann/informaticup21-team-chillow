...
Etwas überraschend hat die \Code{NotKillingItselfAI} am besten abgeschnitten, obwohl andere Taktiken wie bereits
erläutert hierauf aufbauen und mindestens gleich gute Entscheidungen treffen sollten.
Um ein genaueres Ergebnis zu erhalten, wurde die Abfrage aus \Anhang{lst:eval-sql-2} ausgeführt, welches die
...
\Code{PathfindingAI} geprüft werden, auch sehr deutlich unter der Anzahl aller Felder liegen kann.
