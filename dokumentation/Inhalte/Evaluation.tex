...
\begin{table}[htb]
    ...
    \begin{tabularx}{\textwidth}{|X|X|X|X|X|X|X|X|}
        \hline
		\textbf{Klasse} & \textbf{Wins} & \textbf{Plays} & \textbf{Gewinn\-rate (\%)} & \textbf{Max Zeit (Sek)} & \textbf{Avg Zeit (Sek)} & \textbf{Avg Zeit oD (Sek)} & \textbf{Deadline eingehalten (\%)} \\ \hline
        Not\-Killing\-Itself\-AI &  &  &  &  &  &  &  \\ \hline
...
\begin{table}[htb]
    ...
    \begin{tabularx}{\textwidth}{|X|X|X|X|X|}
        \hline
		\textbf{Klasse} & \textbf{Info} & \textbf{Wins} & \textbf{Plays} & \textbf{Gewinnrate (\%)} \\ \hline
        Not\-Killing\-Itself\-AI &  &  &  &  \\ \hline
    \end{tabularx}
